...
import { Xexp, NXbitChainlinkV2, VRFCoordinatorV2ERC677ReceiverMock } from "../typechain-types";
...
import {
  ...
  CALLBACK_GAS_LIMIT,
  LINK_THRESHOLD,
} from "./Prerequisites_NXbitChainlinkV2";

const FIRST_SWAP_ID = 1; // first swap

describe("Xbit_chainlink_v2", function () {
  let owner: any, maintainer: any, addr1: any, addr2: any;
  let vrf: VRFCoordinatorV2ERC677ReceiverMock,
    weth: Contract,
    wbtc: Contract,
    usdt: Contract,
    usdc: Contract,
    xexp: Xexp,
    xbit: NXbitChainlinkV2,
    xabi: Contract;
